...
# print("If my algorithm were perfect, the number of fish would be 5000, but my actual value is " + str(fish_count) + " the error is " + str(100 * (fish_count - 50000.0)/50000) + "%")
